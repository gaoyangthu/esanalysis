 ...
 * 
 * 
 * @see org.apache.hadoop.hbase.client.HConnectionManager
 * @author Costin Leau
 */
public class HbaseConfigurationFactory {

    private static final Log log = LogFactory.getLog(HbaseConfigurationFactory.class);
	...
	public void afterPropertiesSet() {
		...
		if (StringUtils.isNotBlank(quorum)) {
