...
public class HbaseUtils {
	 ...
	 */
	public static HbaseSystemException convertHbaseException(Exception ex) {
	...
	static Charset getCharset(String encoding) {
		return (StringUtils.isNotBlank(encoding) ? Charset.forName(encoding) : Charset.forName("UTF-8"));
	}
