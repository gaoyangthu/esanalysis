 ...
 * {@link org.apache.hadoop.hbase.client.ResultScanner} but  without having to worry about exception handling or resource management.
 * 
 * @author Costin Leau
 */
public interface ResultsExtractor<T> {
	...
	/**
	 * Implementations must implement this method to process the entire {@link org.apache.hadoop.hbase.client.ResultScanner}.
	 *  
	 * @param results {@link org.apache.hadoop.hbase.client.ResultScanner} to extract data from. Implementations should not close this; it will be closed
