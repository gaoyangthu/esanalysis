...
/**
 * Base class for {@link HbaseTemplate}, defining commons properties such as {@link org.apache.hadoop.hbase.client.HTableInterfaceFactory} and {@link org.apache.hadoop.conf.Configuration}.
 * 
...
public abstract class HbaseAccessor {
	...
	public void afterPropertiesSet() {
		if(configuration == null) {
			throw new IllegalArgumentException("A valid configuration is required");
		}
		// detect charset
